...
def calculate_tot_profit2016(landuse_map_in,cellarea):
 all_profits = []
 ...
 for land_use_map in landuse_map_in:
  ...
  # total profi agriculture is equal to sum of different products
...
def calculate_area2016(landuse_map_in,cellarea):
 # loop over the individuals in the population
 all_area = []
 for land_use_map in landuse_map_in:
